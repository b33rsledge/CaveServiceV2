...
import dk.msdo.caveservice.repositories.MongoDBRoomRepositoryImpl;
...
@SpringBootTest(classes = {MongoDBRoomRepositoryImpl.class,
        Configuration.class},
        properties = {"storage.room=mongoStorage"})
// Load the RedisDB test container defined in TestContainerRedisDB
@ContextConfiguration(initializers = TestContainerMongoDB.Initializer.class)
public class RoomRepositoryMongoStorageTest extends RoomRepositoryTests {

    @Autowired
    MongoDBRoomRepositoryImpl storage;
